...
DROP POLICY IF EXISTS "Allow public read of active tenants by code" ON tenants;
...
DROP POLICY IF EXISTS "Allow device registration" ON pos_devices;
...
DROP POLICY IF EXISTS "Allow device updates" ON pos_devices;
...
DROP POLICY IF EXISTS "Allow device read" ON pos_devices;
...
DROP POLICY IF EXISTS "Allow public read of active licenses" ON licenses;
